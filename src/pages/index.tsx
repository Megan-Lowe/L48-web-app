    ...
    <>
      ...
      <div>
        <div class="flex flex-col md:flex-row">
          <div className="mx-auto bg-amber-50 p-5 basis-1/2">
            ...
            <Text color="black">
              ...
              new to paddling or have years of paddling of experience, you’ll
              love getting on the ocean in a fun, inclusive, and supportive
              ...
              <b>Program Fees:</b> $280 for six month season (Saturday only
        ...
        <div class="flex flex-col md:flex-row">
          <img
            ...
            alt="a crew of paddlers wearing green jerseys aproach a bridge in their OC6"
          />
          <div className="mx-auto bg-lime-500 p-5 basis-1/2">
            <Text
              variant="heading1"
              transform="uppercase"
              className="text-lg"
        ...
        <div class="flex flex-col md:flex-row">
          <div className="mx-auto bg-amber-50 p-5 basis-1/2">
            ...
            <Text color="black">
              ...
              have accountability to each other and the coaches to attend
              practice and work towards being their best on and off the water.{" "}
              <br />
              <b>Coach:</b> James Hill and Melanie Conard
              <br />
              <br />
              <b>Schedule:</b> Tuesday and Thursday @ 6pm and Sunday @ 9am{" "}
              <br />
              Additional OC1 training is an expectation for this program and
              regular OC1 time trials are part of crew selections.
              <br />
              <b>Racing:</b> The competitive team competes in local, regional
              and international races through the late fall, spring and summer.
              <br /> <br />
      ...
      <br /> <br /> <br />
      <div className="relative columns-1 sm:columns-2 gap-0">
        <div className="container mx-auto bg-amber-50 p-5">
          <Text variant="heading1" transform="uppercase" className="text-lg">
            HORIZON
          </Text>
          <Text color="black">
        ...
        <img className="w-full" src="/images/meridianprogram.jpeg" />
        <div className="container mx-auto bg-amber-50 p-5">
          <Text variant="heading1" transform="uppercase" className="text-lg">
            Competitive
          </Text>
        ...
        <img class="w-full" src="/images/horizonprogram.jpeg" />
        <div className="container mx-auto bg-amber-50 p-5">
          <Text variant="heading1" transform="uppercase" className="text-lg">
            Meridian
          </Text>
        ...
        <img className="w-full" src="/images/compprogram.jpeg" />
      </div>
      */ /*
